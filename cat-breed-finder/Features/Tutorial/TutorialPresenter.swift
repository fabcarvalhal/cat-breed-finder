    ...
    var stepsViewModels: [TutorialCellViewModel] {
        [
            ...
            TutorialCellViewModel(image: UIImage(named: "detailsScreenTutorial"),
                                  ...
                                  description: "Find a lot of information about the selected breed on the details screen and even save one as your favourite by tapping the star icon if you want."),
            TutorialCellViewModel(image: UIImage(named: "favouritesScreenTutorial"),
                                  title: "See your favourites",
                                  description: "See the favourites you saved without having to load from internet"),
